    ...
    return(
        <div className="WF_list" > 
            ...
            <button className="addBtn">
                    <Link className="addButton" to='/AddWorkoutFolder'><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">
